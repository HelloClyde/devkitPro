...
rem set MSYSCON=unknown
rem if "x%1" == "x-norxvt" set MSYSCON=sh.exe
rem if "x%1" == "x--norxvt" set MSYSCON=sh.exe
rem if "x%1" == "x-rxvt" set MSYSCON=rxvt.exe
rem if "x%1" == "x--rxvt" set MSYSCON=rxvt.exe
rem if "x%1" == "x-mintty" set MSYSCON=mintty.exe
rem if "x%1" == "x--mintty" set MSYSCON=mintty.exe
rem if NOT "x%MSYSCON%" == "xunknown" shift

set MSYSCON=Console.exe
...
if "x%MSYSCON%" == "xConsole.exe" goto startconsole2
...
:startconsole2
if NOT EXIST %WD%mintty.exe goto startmintty
start %WD%Console.exe -t bash
exit
